<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        <a href="{{ route('admin.dashboard') }}" class="d-flex align-items-center">
            <!-- Logo untuk sidebar normal -->
            <div class="app-sidebar-logo-default d-flex align-items-center">
                <img alt="ePustaka Logo" src="{{ asset('assets/images/logo-epustaka.svg') }}" class="h-35px me-2" />
                <span class="text-dark fw-bold fs-6">ePustaka</span>
            </div>
        </a>
            ...
            <span class="svg-icon svg-icon-2 rotate-180">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <path opacity="0.5"
                        ...
                        fill="currentColor" />
                    <path
                        d="M8.2657 11.4343L12.45 7.25C12.8642 6.83579 12.8642 6.16421 12.45 5.75C12.0358 5.33579 11.3642 5.33579 10.95 5.75L5.43431 11.2657C5.04678 11.6532 5.04678 12.3468 5.43431 12.7343L10.95 18.25C11.3642 18.6642 12.0358 18.6642 12.45 18.25C12.8642 17.8358 12.8642 17.1642 12.45 16.75L8.2657 12.5657C7.95328 12.2533 7.95328 11.7467 8.2657 11.4343Z"
                        fill="currentColor" />
                </svg>
            </span>
        </div>
    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div class="menu-item {{ request()->routeIs('admin.books*') ? 'here show' : '' }}" data-menu="books">
                    <a class="menu-link" href="{{ route('admin.books.index') ?? '#' }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="menu-item {{ request()->routeIs('admin.categories*') ? 'here show' : '' }}"
                        ...
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M8.7 4.19L4.21 8.68C3.84 9.05 3.84 9.65 4.21 10.02L8.7 14.51C9.07 14.88 9.67 14.88 10.04 14.51C10.41 14.14 10.41 13.54 10.04 13.17L6.87 10L10.04 6.83C10.41 6.46 10.41 5.86 10.04 5.49C9.67 5.12 9.07 5.12 8.7 5.49V4.19Z"
                                        fill="currentColor" />
                                    <path opacity="0.3"
                                        d="M13.96 4.19L18.45 8.68C18.82 9.05 18.82 9.65 18.45 10.02L13.96 14.51C13.59 14.88 12.99 14.88 12.62 14.51C12.25 14.14 12.25 13.54 12.62 13.17L15.79 10L12.62 6.83C12.25 6.46 12.25 5.86 12.62 5.49C12.99 5.12 13.59 5.12 13.96 5.49V4.19Z"
                                        fill="currentColor" />
                                </svg>
                            </span>
                        </span>
